  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center bg-popover text-popover-foreground ring-foreground/10 data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90 tablet:w-(--radix-navigation-menu-viewport-width) relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-lg shadow ring-1 duration-100",
          className,
        )}
        {...props}
      />
...
function NavigationContentItem({
  ...
  children,
  ...props
}: React.ComponentProps<"li"> & { elementId: string }) {
  return (
    <li
      className={cn(
